...
export const addNewSoftwareApplication = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://backend-portfolio-n2az.onrender.com/api/v1/softwareApplication/add",
      data,
      {
        withCredentials: true,
...
export const deleteSoftwareApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://backend-portfolio-n2az.onrender.com/api/v1/softwareApplication/delete/${id}`,
      {
        withCredentials: true,
      }
    );
