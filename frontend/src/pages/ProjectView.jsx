...
const ProjectView = () => {
  ...
  useEffect(() => {
    const getProject = async () => {
      await axios
        .get(`https://backend-portfolio-n2az.onrender.com/api/v1/project/get/${id}`, {
  ...
  return (
    <>
      <div className="flex mt-7 justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4  px-4">
        <div className="w-[100%] px-10 md:w-[1000px] pb-5 ">
            ...
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 flex flex-col gap-5">
                <div className="w-full sm:col-span-4">
                  ...
                  <img
                    src={projectBanner ? projectBanner : "./images/forget.webp"}
                    alt="project image"
